...
/**
 * Metadata Response (Version: 8) => throttle_time_ms [brokers] cluster_id controller_id [topics] cluster_authorized_operations TAG_BUFFER
 ...
 *   controller_id => INT32
 *   topics => error_code topic_id is_internal [partitions] topic_authorized_operations TAG_BUFFER
 *     error_code => INT16
 *     topic_id => UUID
 *     is_internal => BOOLEAN
...
const topicMetadata = decoder => ({
  ...
  topicAuthorizedOperations: decoder.readInt32(),
  _taggedFields: decoder.readTaggedFields(),
})
